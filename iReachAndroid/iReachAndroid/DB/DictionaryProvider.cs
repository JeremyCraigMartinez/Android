...
namespace SearchableDataBase
{
	[ContentProvider ( new string[]{"com.epsl.ireachandroid"})]
	public class DictionaryProvider : ContentProvider
	{
		public static readonly String AUTHORITY = "com.epsl.ireachandroid";
		public static readonly Android.Net.Uri CONTENT_URI = Android.Net.Uri.Parse ("content://" + AUTHORITY + "/dictionary");
		// MIME types used for searching words or looking up a single definition
		public static readonly String WORDS_MIME_TYPE = ContentResolver.CursorDirBaseType + "/vnd.com.epsl.ireachandroid";
		public static readonly String DEFINITION_MIME_TYPE = ContentResolver.CursorItemBaseType + "/vnd.com.epsl.ireachandroid";
